...
export default function MC2024() {
  const navigate = useNavigate();
  const [selectedCategory, setSelectedCategory] = useState<Category>('all');
  const questions = getQuestionsByCategory(selectedCategory, '2024');
    ...
    <div>
      <div className="flex items-center justify-between px-6 pt-16 pb-5 bg-gray-50 border-b border-gray-200">
        ...
        <div className="flex-1 text-center">
          ...
          <div className="w-12 h-0.5 bg-green-500 rounded mt-1.5 mx-auto" />
        </div>
        <div className="w-10" />
      </div>
      ...
      <div className="px-5 pt-4 pb-3 bg-gray-50">
        <p className="text-base text-gray-600 opacity-65 font-medium text-center">
          2024 Mobile Computing Exam Questions & Answers
        </p>
      </div>
