...
import { getIWTQuestionById } from '../data/iwt-questions'
import { IWTQuestionDetail as IWTQuestionDetailComponent } from '../components/IWTQuestionDetail'

export default function IWTQuestionDetail() {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const question = getIWTQuestionById(id || '');
  ...
  return (
    <div>
      ...
      <div className="overflow-y-auto">
        <IWTQuestionDetailComponent question={question} />
      </div>
    </div>
  );
}
